...
export default async function Home() {
  ...
  const schema = { "@context": "https://schema.org", "@graph": [
    { "@type": "BeautySalon", "@id": `${siteUrl}/#organization`, name: "hato Beauty", url: siteUrl, logo: mediaUrl("/brand/hato-logo-transparent-v3.png"), telephone: ["+84703214868", "+84915860446"], email: "hatobeautydanang@gmail.com", address: { "@type": "PostalAddress", streetAddress: "127 Châu Thị Vĩnh Tế", addressLocality: "Ngũ Hành Sơn", addressRegion: "Đà Nẵng", addressCountry: "VN" }, hasMap: "https://www.google.com/maps/search/?api=1&query=127%20Ch%C3%A2u%20Th%E1%BB%8B%20V%C4%A9nh%20T%E1%BA%BF%2C%20Ng%C5%A9%20H%C3%A0nh%20S%C6%A1n%2C%20%C4%90%C3%A0%20N%E1%BA%B5ng", openingHours: "Mo-Su 08:00-19:30", sameAs: ["https://www.tiktok.com/@hatobeauty", "https://www.instagram.com/hatobeauty/", "https://facebook.com/hatobeautyy", "https://wa.me/84703214868"] },
