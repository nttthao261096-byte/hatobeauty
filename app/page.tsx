...
export const metadata: Metadata = {
  ...
  openGraph: { url: siteUrl, locale: "vi_VN", title: "hato Beauty Đà Nẵng | SHINE AS YOU ARE", description: "Năm nhóm chăm sóc thẩm mỹ với thông tin rõ ràng cho khách Việt Nam và quốc tế.", images: [{ url: mediaUrl("/og-shine.png"), width: 1731, height: 909 }] },
  twitter: { card: "summary_large_image", title: "hato Beauty Đà Nẵng | SHINE AS YOU ARE", description: "Năm nhóm chăm sóc thẩm mỹ với thông tin rõ ràng cho khách Việt Nam và quốc tế.", images: [mediaUrl("/og-shine.png")] },
};
