...
export const metadata: Metadata = {
  ...
  openGraph: {
    url: siteUrl,
    locale: "vi_VN",
    title: "Hato Beauty Đà Nẵng | Chăm sóc theo nhu cầu",
    description:
      "Năm nhóm dịch vụ: Chăm sóc da, Mi & Mày, Chăm sóc da đầu & Thư giãn, Triệt lông và Tẩy lông.",
    images: [{ url: mediaUrl("/og-shine.png"), width: 1731, height: 909 }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Hato Beauty Đà Nẵng | Chăm sóc theo nhu cầu",
    description:
      "Chăm sóc da, Mi & Mày, Chăm sóc da đầu & Thư giãn, Triệt lông và Tẩy lông.",
...
export default async function Home() {
    ...
    "@graph": [
      {
        ...
        name: "Hato Beauty",
        url: siteUrl,
        logo: mediaUrl("/brand/hato-logo-transparent-v3.png"),
        telephone: "+84703214868",
        email: "hatobeautydanang@gmail.com",
        address: {
          "@type": "PostalAddress",
          streetAddress: "127 Châu Thị Vĩnh Tế",
        ...
        sameAs: [
          ...
          "https://facebook.com/hatobeautyy",
          "https://wa.me/84703214868",
        ],
      },
      {
        "@type": "WebSite",
  ...
  return (
    <>
      <JsonLd data={schema} />
      <HatoHome
        content={{ services: content.services, highlights: content.highlights }}
        initialLang="vi"
      />
    </>
  );
