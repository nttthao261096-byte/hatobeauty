...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const paths = ["/", "/en/", "/dich-vu/", "/en/services/", "/san-pham-cham-soc/", "/en/care-products/", "/lo-trinh/", "/en/care-plan/", "/kien-thuc/", "/en/journal/", "/ve-hato-beauty/", "/en/about/", "/lien-he/", "/en/contact/", "/ket-qua/", "/en/results/", "/bang-gia/", "/en/prices/", "/dat-lich/", "/en/book/", "/chinh-sach-bien-tap/", "/en/editorial-policy/", "/chinh-sach-bao-mat/", "/en/privacy/", ...seoServices.flatMap(s => [servicePath(s,"vi"),servicePath(s,"en"),journalPath(s,"vi"),journalPath(s,"en")])];
