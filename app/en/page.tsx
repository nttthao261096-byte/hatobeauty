...
export const metadata: Metadata = { title: { absolute: "hato Beauty Da Nang | Skin, Head Spa, Body & Beauty Care" }, description: "Explore Skin, Head Spa, Body, Brow & Lash, Waxing and Hair Removal at hato Beauty in Da Nang, with clear English service information.", alternates: { canonical: "/en/", languages: { "vi-VN": "/", en: "/en/", "x-default": "/" } }, openGraph: { url: `${siteUrl}/en/`, locale: "en_US", title: "hato Beauty Da Nang | SHINE AS YOU ARE", description: "Six considered beauty care worlds for Vietnamese and international guests.", images: [mediaUrl("/og-shine.png")] }, twitter: { card: "summary_large_image", title: "hato Beauty Da Nang | SHINE AS YOU ARE", description: "Six considered beauty care worlds for Vietnamese and international guests.", images: [mediaUrl("/og-shine.png")] } };
