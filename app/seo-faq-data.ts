...
export const journalIntentFaqs: Record<SeoService["id"], LocalizedFaqs> = {
  ...
  waxing: { vi: [["Tẩy lông mày có cần tạo dáng trước không?", "Kỹ thuật viên sẽ trao đổi dáng mong muốn trước khi làm sạch và thực hiện."], ["Khi nào nên hoãn waxing?", "Hoãn khi da đang kích ứng, trầy xước, cháy nắng hoặc nhạy cảm do hoạt chất mạnh."]], en: [["Should brow shape be decided before waxing?", "The desired shape is discussed before cleansing and hair removal begin."], ["When should waxing be postponed?", "Postpone when skin is irritated, broken, sunburned or sensitised by strong active products."]] },
};
