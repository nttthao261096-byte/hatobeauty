...
export interface SeoService {
  id: "skin" | "scalp" | "body" | "brow-lash" | "hair-removal";
  viSlug: string;
  enSlug: string;
  image: string;
  vi: SeoServiceCopy;
...
export const seoServices: SeoService[] = [
  {
    id: "skin", viSlug: "cham-soc-da-chuyen-sau-da-nang", enSlug: "facial-treatment-da-nang", image: "/images/service-skin-v2.webp",
    vi: {
      name: "Chăm sóc da chuyên sâu", title: "Chăm sóc da chuyên sâu tại Đà Nẵng",
      description: "Liệu trình chăm sóc da tại hato Beauty tập trung làm sạch, cấp ẩm và phục hồi theo tình trạng da được trao đổi trước buổi hẹn.",
  ...
  {
    id: "body", viSlug: "cham-soc-da-body-da-nang", enSlug: "body-treatment-da-nang", image: "/images/service-body-scrub-v2.webp",
  ...
  {
    id: "brow-lash", viSlug: "uon-mi-brow-lamination-da-nang", enSlug: "lash-lift-brow-lamination-da-nang", image: "/images/service-brow-v2.webp",
    vi: { name: "Uốn mi & Brow Lamination", title: "Uốn mi & Brow Lamination tại Đà Nẵng", description: "Định hình chân mày và nâng cong hàng mi theo đường nét tự nhiên của gương mặt.", answer: "Uốn mi và Brow Lamination giúp sắp xếp hàng mi, sợi mày theo hướng gọn gàng và tự nhiên hơn. hato trao đổi về dáng, độ cong và thói quen chăm sóc trước khi thực hiện; dịch vụ này khác với nối mi.", suitable: "Khách muốn mi cong nhẹ, chân mày rõ nét hơn và dễ chăm sóc hằng ngày.", caution: "Cần hoãn khi vùng mắt hoặc da quanh mày đang kích ứng, viêm hoặc vừa thực hiện thủ thuật khác chưa ổn định.", preparation: ["Đến với vùng mắt và chân mày sạch", "Chia sẻ tiền sử nhạy cảm với sản phẩm", "Trao đổi rõ phong cách mong muốn"], aftercare: ["Giữ vùng thực hiện khô theo hướng dẫn ban đầu", "Không chà xát mạnh", "Chải và dưỡng theo hướng dẫn của kỹ thuật viên"], expectations: "Độ cong và dáng mày duy trì khác nhau theo sợi tự nhiên, chu kỳ mọc và chăm sóc tại nhà.", faq: [["Lash lift có phải nối mi không?", "Không. Lash lift tạo độ cong cho mi tự nhiên, không gắn thêm sợi nối."], ["Kết quả giữ được bao lâu?", "Thời gian khác nhau theo chu kỳ sợi và cách chăm sóc; hato sẽ hướng dẫn sau buổi hẹn."]]},
...
export const journalTopics = seoServices.map((service) => ({
  id: service.id,
  viSlug: service.id === "skin" ? "cham-soc-da" : service.id === "scalp" ? "goi-dau-duong-sinh" : service.id === "body" ? "cham-soc-body" : service.id === "brow-lash" ? "mi-chan-may" : "triet-long",
  enSlug: service.id === "skin" ? "facial-care" : service.id === "scalp" ? "head-spa" : service.id === "body" ? "body-care" : service.id === "brow-lash" ? "brow-lash" : "hair-removal",
  image: service.image,
  service,
}));
