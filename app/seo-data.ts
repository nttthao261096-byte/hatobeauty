...
export const seoServices: SeoService[] = [
  ...
  },
  {
    ...
    vi: { name: "Tẩy lông", title: "Tẩy lông tại Đà Nẵng", description: "Tẩy lông bằng sáp theo từng vùng với quy trình kín đáo, nhanh gọn và chú trọng làm dịu da.", answer: "Tẩy lông tại hato Beauty sử dụng kỹ thuật waxing phù hợp với từng vùng như chân mày, môi trên hoặc vùng cơ thể. Quy trình gồm làm sạch, chuẩn bị da, thực hiện và làm dịu sau dịch vụ; mức thoải mái và thời gian duy trì khác nhau ở mỗi người.", suitable: "Khách cần làm gọn lông mày, môi trên hoặc một vùng cơ thể với hiệu quả thấy ngay sau buổi chăm sóc.", caution: "Hoãn khi vùng da đang trầy xước, cháy nắng, kích ứng hoặc vừa sử dụng hoạt chất làm da nhạy cảm.", preparation: ["Giữ vùng da sạch và không tẩy tế bào chết mạnh", "Báo trước sản phẩm hoặc thuốc đang dùng", "Để chiều dài sợi phù hợp theo hướng dẫn"], aftercare: ["Giữ vùng da sạch và thoáng", "Hạn chế nắng, nhiệt và ma sát mạnh", "Dưỡng ẩm và làm dịu theo hướng dẫn"], expectations: "Bề mặt da có thể gọn và mịn hơn ngay sau buổi thực hiện. Mức đỏ nhẹ, cảm giác và thời gian lông mọc lại phụ thuộc vùng da và cơ địa.", faq: [["Tẩy lông gồm những vùng nào?", "hato phục vụ tẩy lông mày, môi trên và các vùng cơ thể được xác nhận trước buổi hẹn."], ["Bao lâu nên tẩy lông lại?", "Tần suất phụ thuộc chu kỳ mọc và vùng thực hiện; thông thường chỉ đặt lại khi sợi đã đạt chiều dài phù hợp."]]},
